...
#define BINDIR "/run/current-system/sw/bin/"
...
static const char *fonts[]          = { 
    ...
    //"fontawesome:size=9:antialias=true",
    "Hack:size=8:antialias=true:autohint=true",
    "JoyPixels:pixelsize=10:antialias=true:autohint=true"
}; // nix-env -i joypixels mononoki hack-font nerd-fonts
...
static const char *termcmd[]  = { "/home/jan/suckless/st/result/bin/st", NULL };
...
static Key keys[] = {
	...
	{ ControlMask|Mod1Mask,         XK_f,      spawn,          SHCMD("qutebrowser") },
...
// 	{ 0, XF86XK_AudioLowerVolume,	spawn,		SHCMD("pamixer --allow-boost -d 3; kill -44 $(pidof dwmblocks)") },
	...
	{ 0, XF86XK_MonBrightnessUp,	spawn,		SHCMD("brightness +50") },
	{ 0, XF86XK_MonBrightnessDown,	spawn,		SHCMD("brightness -50") },
};
